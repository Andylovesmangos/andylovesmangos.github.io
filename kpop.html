            ...
            for (let e of x) {
                ...
                if (document.getElementById("groupname").value === "" || e.getElementsByTagName("group")[0].childNodes[0].nodeValue.toUpperCase().includes(document.getElementById("groupname").value.toUpperCase())) {
                    ...
                    if (e.getElementsByTagName("pic")[0] !== undefined) {
                        display.push(`<img onclick="displayName('${e.getElementsByTagName("name")[0].childNodes[0].nodeValue}', '${e.getElementsByTagName("group")[0].childNodes[0].nodeValue}')" class="picture" src="${e.getElementsByTagName("pic")[0].childNodes[0].nodeValue}"></img>`);
                    }
                }
            }
